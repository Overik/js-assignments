https://github.com/Trickster69/js-assignments
#Sergei Demchuk

## Javascript Assignments [![Build Status](https://travis-ci.com/github/Trickster69/js-assignments.svg?branch=master)](https://travis-ci.org/Trickster69/js-assignments)
